...
# 정규화
library("caret")
columns = c('FG_PCT_home', 'FT_PCT_home', 'FG3_PCT_home', 'AST_home', 'REB_home', 'FG_PCT_away', 'FT_PCT_away', 'FG3_PCT_away', 'AST_away', 'REB_away')
...
selected.columns = c('FG_PCT_home', 'FG3_PCT_home', 'AST_home', 'FG_PCT_away', 'FG3_PCT_away', 'AST_away', 'HOME_TEAM_WINS')
games.df = games.df[selected.columns]
...
games.best.model = tune.svm(HOME_TEAM_WINS~.,
...
train.model = svm(HOME_TEAM_WINS~.,
    data = train.df,
